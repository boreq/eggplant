...
RUN mkdir -p backend/_build && go build -C backend -tags withfrontend -ldflags "-X github.com/boreq/eggplant/entrypoints/http.Version=$(cat /version.txt)" -o ./_build/eggplant ./cmd/eggplant
